...
public class ChangeState : MonoBehaviour
{
	...
	void Update ()
    {
        if (true == trigger)
        {
            ...
            Debug.Log("WORLDSTATE: " + color + ", " + weight);
            changeState((int)(controller.transform.position.x * 10) + 10, (int)(controller.transform.position.y * 10), (int)(controller.transform.position.z * 10) + 10, color, weight);
            //changeState((int)(controller.transform.position.x * 10), (int)(controller.transform.position.y * 10), (int)(controller.transform.position.z * 10), 1, 1);
        }
