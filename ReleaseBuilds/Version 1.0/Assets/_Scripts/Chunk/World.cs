...
public class World : MonoBehaviour
{
    ...
    public void GenColumn(int x, int z)
    {
        for (int y = 0; y < chunks.GetLength(1); y++)
        {
            ...
            GameObject newChunk = Instantiate(chunk, new Vector3(scale * x * chunkSize - 0.5f * scale - 1, scale * y * chunkSize + 0.5f * scale, scale * z * chunkSize - 0.5f * scale - 1), new Quaternion(0, 0, 0, 0)) as GameObject; 
