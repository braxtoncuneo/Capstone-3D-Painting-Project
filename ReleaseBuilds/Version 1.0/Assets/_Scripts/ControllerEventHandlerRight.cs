namespace VRTK.Examples
{
    ...
    public class ControllerEventHandlerRight : MonoBehaviour
    {
        ...
        public Brush brush;
        public GameObject colorPicker, leftControllerModel, rightControllerModel, cursorSphere;
        public Material sphereMat;
        public VRTK_Pointer vrtkPtr;
        ...
        private void Update()
        {
            ...
            brush.transform.Rotate(45, 0, 0);

            if (brushDown && !vrtkPtr.IsPointerActive())
            {
                //draw
            ...
            else if (gripDown && !vrtkPtr.IsPointerActive())
            {
                //erase
        ...
        private void Start()
        {
            ...
            //cursor object - will be removed upon later update
            cursorSphere.transform.localScale = new Vector3(scaleXZ, scaleY, scaleXZ) * 1.1f;
        }
