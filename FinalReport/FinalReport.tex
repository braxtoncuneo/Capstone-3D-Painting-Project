...
Fall/1 & Christopher & 
Get preferences DONE BEFORE THURSDAY. Get one note working and learn some cool stuff about how to run it
&
OneNote is kind of weird, it will take some getting used to
&
Have completed the setup of the year of progress. All weeks and subpages have been setup
&
I got the submissions turned in. One note is tolerable. Made some friends and I think I have a project already laid out. Had fun with the bio
...
\\ \hline
Fall/2 & Christopher & 
Get ahead in some of my other classes. Get started on the rough draft of my proposal. Get organized with Braxton and Richard
&
No problems here
&
In line with project and classes
&
Worked on problem statement
Collaborated a little on the final copy
...
\\ \hline
Fall/3 & Christopher & 
Meeting with Baily Winters. Meeting with Braxton and Richard
&
Figuring out schedules. Processes in working together. Collaboration techniques
&
Had our meetings with bailey Richard took notes. We have a new outline for our project
&
We are making our project more about the creation of virtual reality tools. These tools will help people create something in the virtual space. This brings up a lot more points when moving out of the scope of just painting
...
\\ \hline
Fall/4 & Christopher & 
Get a final copy done by Thursday. Problem statement outline needed. Scale in the requirements

&
There is a lot to think about in this project. Lots of features that would be cool but are not necessary. Judging how we should be either specific of general in some categories of the outline

&
Copy of problem statement sent to bailey and winters. Discussion of some implementation. Research into Unity vs unreal. Topic for next week: requirements

&
Scope of the project. Establish meeting and contact with project manager. Proposal established and under review
...
\\ \hline
Fall/5 & Christopher & 
Get a rough draft of Requirements. Meeting with project manager
&
Some scheduling conflicts I need to work out. We have not met with bailey and winters on feedback for problem statement. Need to get down difference between requirements/constraints and implementation.

&
We have a rough draft of requirements

&
Had some meetings. Made the rough draft of the requirements
...
&
Learn about Gantt chart
&
Pushed to git repo the gantt chart. Edits from Bailey and Winters
&
Requirements document finished
...
\\ \hline
Fall/7 & Christopher & 
Review Requirements doc with TA. Get assigned tasks for tech review
&
Richard and Braxton are a bit preoccupied with other classes and I'll admit I am as well
&
We have gotten confirmation from our TA for the Requirements document. We have had a discussion with Winters about the tech review and some of the components we will be diving into
&
Requirements confirmed with TA. Assigned rolls for tech review
...
\\ \hline
Fall/8 & Christopher & 
Collaborate with tech review. Get rough draft for tech review finished due 21st
&
None
&
Tech review done
...
\\ \hline
Fall/9 & Christopher & 
Work on design doc. Tech review meeting collaboration

&
Meeting pushed to next week, we will have to collab on our own
&
Finish tech review edits. Final copy

&
Meeting canceled. Finish tech review final copy. Start on design doc
...
Finish design doc
&
No meeting this week (not really a problem but a note)
&
...
Get started with Unity. Meet with group and have some communication about where we are going. Get in contact with project manager. Have new revision of Design doc for Bailey/Winters

&
Havent got an email from Andrew yet (project manager)

&
Have unity account. Design doc revision is in

&
Pretty slow week. Waiting on Design doc comments
...
Meeting with bailey and winters. Make some headway on the analog and digital tests I need

&
A little bit of a blocker on how output data should be formatted

&
Made some good progress on the designs and specs of the UI. Good meeting with Bailey and winters

&
Need to meet with Richard and Braxton next week for coordination. Get those test structured and ready for VR
...
Meet with Richard and Braxton. Optitrack demo

&
Still a little blocked on the data formatting for UI output, but that will hopefully be cleared up next week

&
More tests on the UI. Meeting with Richard and Braxton

&
Create a good skeleton. VR tests almost ready. Technology review with the tour of the company I work at OptiTrack (naturalpoint). Set up some meeting times with Bryan, our Intel Contact
...
Work on alpha build
&
Hardware limitations there is a limiting factor on the hardware we have available
&
Kept working on UI and get general functions working
&
Meeting times with Clients and some progress on UI
...
Get set up with HMD and coordinate with braxton and richard
&
Still no suitable substitute for virutal HMD except for the onsite lab
&
UI still in progress but some promising solution on 3D UI objects
&
Set up goals for alpha build. Progress on UI
...
Have a stable alpha build working
&
No optimal hardware to work on. We need a dedicated HMD and workstation for our group, right now we are just working in the lab
&
Have alpha build working and report written
&
Have stable alpha build, midterm report and presentation
...
Get HMD and VR tools set up 
&
Still do not have work station or GPU
&
Progress for UI and our interface

&
Richard is buying the HMD this Saturday. Work done on UI. Progress on connect top and bottom layers
...
Meet with clients and cover beta requirements. Coordinate with Richard to attach lower level functions to UI
&
Time limitation - working over the weekend now
&
Meeting success. Set up time this weekend
&
Saturday - Sunday wrap up 90 percent beta
...
&
Working on hooking up VR controllers to various pieces of the system
&
Working on beta. Getting to feature complete
...
Have beta finished. Feature complete
Going to meet with Richard Saturday to hook up the UI
&
Work will have to be done on the weekends
&
Working on implementing new UI features
&
Finishing beta and reports
...
Alpha feature list complete.
&
Still no working save load. Need more UI mappings

&
Have initial function list

&
Created temporary function list for the back end mappings.
...
Refactoring general structure of polyvox. There is simply too much going on in the hierarchy so we need to cut that down and streamline things to make it easier on ourselves
&
A few different version of Unity we are using makes it a bit difficult to work with
&
Have eliminated some of the unnecessary features and structures. Richard has got a separate build that is more streamlined and better for what we are looking for
&
Get Rid of all the unnecessary stuff without breaking the build is a lot harder than it sounded
...
Continue working on beta build. Need to have this complete before expo on 18th
&
Still working with some new controller mapping and fussing with the current UI
&
Have some initial progress and goals for next week on what we need for the UI and controller mappings
&
Executing plans for new UI structure and controller mappings
...
Implement new UI structure. Create save and load feature (this will be passed on to Richard)
&
The UI pointers still have some bugs in them and are not particularly portable code. Managing them will need some work.
&
Have the UI pointers implemented and believe we have fixed all the bug
&
Implemented UI pointers. Save and load feature
...
New UI controller mappings. Taking out the UI pointers and using analogue mappings instead
&
Old controller event handler will need to be rewritten to support new controller functions
&
Have a working build without the UI pointers

&
Have alternate controller mappings for core functions
...
Get our software tested by outside opinion
&
Need to add somethings to make it an easier experience
&
Have a demo ready build for expo
&
Have a demo ready build for expo and all the feature we are showing off.
...
Survived expo
&
We made to expo and had a great show
...
Working on other classes this week
&
none
&
none
&
Took a break from polyvox to catch up on other classes
...
Meet up with Brain. Any last minute changes
&
none
&
Had our meeting and are wrapping up the software
&
Final wrap up of polyvox
...
None
&
Finished slides and final presentation
&
Showing off what we had done all year with our awesome presentation
...
\subsection{Brush Compute Shader}
\begin{minted}
[
frame=lines,
framesep=2mm,
...
\pagebreak
\subsection{Update Skip Grid Compute Shader}
\begin{minted}
[
frame=lines,
framesep=2mm,
...
\pagebreak
\subsection{Wipe Brush Compute Shader}
\begin{minted}
[
frame=lines,
framesep=2mm,
