    ...
    public class ControllerEventHandlerRight : MonoBehaviour
    {
        ...
        public void loadFile(string f)
        {
            if ("" != f)
            {
                ...
                if (File.Exists("SaveFiles/" + f + ".txt"))
                {
                    brush.Wipe(new Vector4(0, 0, 0, 0), new Vector4(0, 0, 0, 0));
                    //clear current canvas
                    saveFile("TempSaveFiles/" + f);
                    string line;
                    System.IO.StreamReader file = new System.IO.StreamReader("SaveFiles/TempSaveFiles/" + f + ".txt");
                    ...
                    File.Delete("SaveFiles/TempSaveFiles/" + f + ".txt");
                    save = "";
                    f = "SaveFiles/" + f + ".txt";
